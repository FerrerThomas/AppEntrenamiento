    ...
    <div className="p-6 pb-32 min-h-screen bg-surface-0 flex flex-col max-w-md mx-auto">
      ...
      <header className="flex justify-between items-center mb-8 pt-2">
        ...
        <div 
          ...
          className="w-12 h-12 rounded-full overflow-hidden border-2 border-primary cursor-pointer hover:opacity-90 transition-transform active:scale-95 shadow-glow"
          title="Ver mi perfil"
        >
      ...
      <div 
        ...
        className="bg-surface-1 border border-surface-2 rounded-2xl p-3 flex items-center justify-between mb-6 cursor-pointer hover:border-primary/50 transition-all active:scale-[0.99]"
      >
        <div className="flex items-center space-x-3">
          <div className="flex -space-x-2">
            ...
            <div className="w-8 h-8 rounded-full bg-surface-2 border-2 border-surface-1 flex items-center justify-center text-xs font-bold z-10 text-primary">+1</div>
          </div>
          <span className="text-sm font-medium text-gray-300">Atletas activos en la comunidad</span>
        </div>
