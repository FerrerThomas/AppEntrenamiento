...
export default function BottomNavigation() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 px-2 pb-5 pt-2 z-50">
      <div className="glass rounded-xl flex items-center justify-around py-1 px-2 mx-auto max-w-md">
        {navItems.map((item) => {
